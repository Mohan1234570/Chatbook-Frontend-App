...
//           sx={{ mb: 4 }}
//         >
//           Join a world where ideas, stories, and emotions connect people every
//           day.
//         </MotionTypography>
...
//   {[
//     {
//       icon: <ChatBubbleOutlineIcon sx={{ fontSize: 40, color: "#1976d2" }} />,
...
const LandingPage: React.FC = () => {
  ...
  // 💡 Quote of the Day (from ZenQuotes API)
