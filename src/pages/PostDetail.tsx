...
// import { setCurrentPost, addComment, updatePost, updateLikes, updateShares, deletePost } from '../store/slices/blogSlice';
...
//       // match reducer signature: pass the full comments array
//       dispatch(
//         addComment({
//           postId: id!,
...
//       // After dispatch(addComment(...));
//       try {
//         const refreshedPost = await blogAPI.getPost(id!);
//         // updatePost doesn't exist -> update the current post (or use the proper action)
