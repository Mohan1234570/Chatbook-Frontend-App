...
// import NotificationMenu from './NotificationMenu'; // <-- add or adjust path

// const Navbar: React.FC = () => {
//   const { isAuthenticated } = useSelector((state: RootState) => state.auth);
//   const notifications = useSelector((state: RootState) => state.notifications?.items ?? []); // provide real value
...
//           {isAuthenticated ? (
//             <>
//               <Button color="inherit" component={RouterLink} to="/create-post">Create Post</Button>
